...
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" method="get" action="/admin/case">
          ...
          <input type="text" name="key" value="{{$request->input('key')}}" placeholder="请输入案件名、案号、时间、" autocomplete="off" class="layui-input" >
      ...
      <table class="layui-table">
        ...
        @foreach($case as $v)
          <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id={{$v->caseid}}><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td>{{$v->caseid}}</td>
            <td>{{$v->title}}</td>
            <td>
      ...
      <div class="page">
        {!! $case->appends($request->all())->render() !!}
      </div>
