...
<html>
    ...
    <div class="x-body layui-anim layui-anim-up">
        <blockquote class="layui-elem-quote">欢迎管理员：
            <span class="x-red">{{$adminInfo->admin_name}}</span>！当前时间:{{ date('Y-m-d H:i:s', time()) }}</blockquote>
...
{{--        </fieldset>--}}
        ...
        <blockquote class="layui-elem-quote layui-quote-nm">本后台系统由x-admin提供技术支持。</blockquote>
    </div>
        <script>
        var _hmt = _hmt || [];
        (function() {
